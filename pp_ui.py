...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1050, 750) #1041, 723
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Global path planning for mobile robot navigation using genetic algorithm"))
        MainWindow.setStyleSheet("background-color: solid pink;")
        self.reset_obstacles.setText(_translate("MainWindow", "Randomize the obstacles"))
        self.reset_obstacles.setStyleSheet("background-color: solid grey;")
        self.iterate.setText(_translate("MainWindow", "generations"))
        self.run.setText(_translate("MainWindow", "start simulation"))
        self.set_points.setText(_translate("MainWindow", "draw points"))
        ...
        self.draw_best.setText(_translate("MainWindow", "optimal path"))
